...
export default function Section() {
    return (
        <>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-[92px] md:gap-[30px] max-w-[1110px] mx-auto w-full relative z-20'>
                <div className="text-center bg-white rounded-[5px] px-8 pt-[77px] pb-[41px] relative h-fit z-20">
                ...
                <div className="text-center bg-white rounded-[5px] px-8 pt-[77px] pb-[41px] relative h-fit md:mt-[44px] z-20">
                ...
                <div className="text-center bg-white rounded-[5px] px-8 pt-[77px] pb-[41px] relative h-fit md:mt-[88px] z-20">
